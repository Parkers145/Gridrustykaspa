...
# Build WASM Wallet 
WORKDIR /rusty-kaspa/wallet/wasm
RUN ./build-web
...
COPY --from=kaspad-builder /rusty-kaspa/wallet/wasm/web /rusty-kaspa/wallet/wasm/web
...
COPY --from=kaspad-builder /rusty-kaspa/target/release /release
